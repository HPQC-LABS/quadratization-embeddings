...
\newcommand\nodescale{1.25} % global scaling factor for nodes
...
\tikzstyle{gn}=[circle,fill=Lime,draw=Black,line width=0.8 pt]
\tikzstyle{yn}=[circle,fill=Yellow,draw=Black,line width=0.8 pt]
\tikzstyle{auxiliary_qubit}=[circle,fill=Red,draw=Black,scale=\nodescale,draw=none]
\tikzstyle{logical_qubit}=[circle,fill=Black,draw=Black,scale=\nodescale,draw=none]
\tikzstyle{emb_logical_qubit}=[circle,fill=Black,draw=Black,scale=\nodescale,draw=none]
\tikzstyle{emb_auxiliary_qubit}=[circle,fill=Red,draw=Black,scale=\nodescale,draw=none]
\tikzstyle{unused_qubit}=[circle,fill=Gray,draw=Gray,scale=\nodescale,draw=none]
\tikzstyle{arrow_end}=[circle,fill=none,draw=none,scale=.1]
...
\tikzstyle{embedding_aux}=[-,draw=Red,line width=3.250]
